...
Ispravan rad funkcije ispitan je tako što je izvršena FFT transformacija rezultata AD pretvorbe jednog kanala korištenjem funkcije \texttt{arm\_rfft\_fast\_f32}. Za ispitivanje je korišten sljedeći odsječak programskog koda:

...
\zahvala{Hvala Karli Salamun na savjetima i pomoći pri izradi ovog rada.}

\tableofcontents

\include{uvod}
\include{arhitektura_pdh}
\include{sklopovlje}
\include{spi}
